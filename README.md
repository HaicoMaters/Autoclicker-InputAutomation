...
Still in very early stages (is somewhat functional it autoclicks and you can change the hotkey (the options for speed need massive reworking) but most features/settings displayed do not work i.e. darkmode etc. and are in need of updating the gui elements to look servicable)
...
- add unit testing
- make readme good when within decent state i.e. the basic features and gui complete
- maybe a panic button to stop the program
